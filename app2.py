...
if st.session_state.selected_recipe is not None:
    # ... (ส่วนนี้คงเดิมตามโค้ดที่คุณให้มา) ...
...
# ==========================================
    ...
    # --- แหล่งที่มาข้อมูล ---
    st.sidebar.markdown("---")
    st.sidebar.markdown("📚 **แหล่งที่มาข้อมูล:**")
    st.sidebar.markdown("• ข้อมูลโภชนาการ: [กองโภชนาการ กรมอนามัย](https://www.anamai.moph.go.th/)")
    st.sidebar.markdown("• การคำนวณ: [สูตร Mifflin-St Jeor](https://en.wikipedia.org/wiki/Harris%E2%80%93Benedict_equation)")
    st.sidebar.markdown("• สูตรอาหาร: Cooking Time Database")